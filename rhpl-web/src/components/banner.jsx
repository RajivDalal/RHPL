const Banner =() =>{
    return (
        ...
        <div className="bg-gradient-to-t from-[#0b2545] to-[#0e6ba8] text-[#e5e5e5] lg:pt-14 pt-10 lg:pb-10 pb-4">
            <p className="lg:text-5xl md:text-[2.5rem] text-4xl leading-none text-center pb-6 font-share">
            ...
            <p className="navmenu lg:text-3xl md:text-2xl text-xl leading-none text-center font-share">(co-located with <a href="https://www.fsttcs.org.in/2025/">FSTTCS 2025</a>)</p>
