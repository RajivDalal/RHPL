...
const Important_dates = () => {
  return (
    ...
    <p className="py-10 space-y-2">
        ...
        <div className="py-10 paraLink">All dates below are in <a classname="underline" href="https://en.wikipedia.org/wiki/Indian_Standard_Time">Indian Standard Time (IST)</a>.</div> 
