    ...
    <div className="content">
      <p className="pt-10 org">
        <ul className="list-[square] space-y-1">
          ...
          <li>
            <a href="https://www.csa.iisc.ac.in/~https://sumanthsprabhu.github.io//"> <span className="underline">Sumanth Prabhu</span> (TCS Research) <RiExternalLinkLine className="inline"/> </a>
          </li>
          <li>
